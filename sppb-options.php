...
class SPPBSettingsPage{
	function SPPB_settingspage(){
   	...
   	function add_menu(){
		...
		if($shoppExtraMenu == 'present'){
      			add_submenu_page('shopp-extra', 'Shopp sppb', 'Shopp sppb',(defined('SHOPP_USERLEVEL') ? SHOPP_USERLEVEL : 'manage_options'), 'sppb-settings', array($this, 'createPage_SPPB'));
		} else {
	...
	function shoppExtraMenuPage() {
		...
		echo "<h2>".__( 'Shoppdeveloper.com - Main Plugin Page', 'sppb' )."</h2>";
